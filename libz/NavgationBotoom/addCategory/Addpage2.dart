...
import 'package:events/NavgationBotoom/addCategory/Addpage3.dart';
...
class _AddPage2State extends State<AddPage2> {
                      ...
                      Container(
                        ...
                        child: TextFormField(
                            ...
                            decoration: new InputDecoration(
                              hintText: "تاريخ انتهاء الفاعلية",
                              hintStyle: TextStyle(
                                  color: Colors.grey,
                                  fontFamily: "thin",
                                  fontSize: 12),
            ...
            secondary: Colors
                ...
                Container(
                  ...
                  child: TextFormField(
                      ...
                      decoration: new InputDecoration(
                          hintText: " ادخل اسم منظم الفاعلية",
                          hintStyle:
                              TextStyle(color: Colors.grey, fontFamily: "thin",),
                          enabledBorder: OutlineInputBorder(
                            borderSide:
  ...
  if (secondtime.text == null||secondtime.text.isEmpty) {
        ...
        CommnWidget.showInSnackBar(
            "رجاء ادخل اسم  منظم الفاعلية", CommnWidget.commonColor, _scaffoldKey);
        return;
      }
