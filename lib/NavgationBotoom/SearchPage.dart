...
import 'package:dailyevent/NavgationBotoom/searchCatogry.dart';
import 'package:dailyevent/NavgationBotoom/searchcity.dart';
import 'package:dailyevent/NavgationBotoom/tasnefatpage2.dart';
import 'package:dailyevent/helper/ApiRequests.dart';
import 'package:dailyevent/helper/Models/SearchModel.dart' as search;
...
class _SearchPageState extends State<SearchPage> {
  ...
  search.Eachcountry searchcontyitem;
  String countryname = "اختر اسم الدولة";
  int countryid;
  int cityid;
  String cityname = "اختر اسم المدينة";
  search.Cities cityitem;
  DateTime start;
  DateTime end;

  int categoryid;
  String categoryname = "اختر التصنيف";
  search.Categories categoryitem;
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  search.SearchMModel _data;
  getdata() {
