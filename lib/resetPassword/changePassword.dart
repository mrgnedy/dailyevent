...
class ChangePasswordPage2 extends StatefulWidget {
  
  final String phone;
  ChangePasswordPage2({this.phone});

  @override
  _ChangePasswordPage2State createState() => _ChangePasswordPage2State();
}

class _ChangePasswordPage2State extends State<ChangePasswordPage2> {
  // String password1;
   String password2;
    String password3;
...
valedate();
 ...
 if(_formKey.currentState.validate()){
  ...
  //_goodleToken
      ...
      _apiRequests.changepassword2(password2,widget.phone).then((value){
     if(value!=null){
if(value){
