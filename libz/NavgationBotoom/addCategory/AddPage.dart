...
import 'package:events/NavgationBotoom/addCategory/Addpage2.dart';
    ...
    if (_formKey.currentState.validate()) {
      ...
      if (_image == null) {
        CommnWidget.showInSnackBar(
            "رجاء اختار صوره الفاعلية", CommnWidget.commonColor, _scaffoldKey);
        return;
      }
      if (catid == null) {
        CommnWidget.showInSnackBar(
            "رجاء اختر نوع الفاعلية", CommnWidget.commonColor, _scaffoldKey);
        return;
      }
      if (categoryaddress.text == null || categoryaddress.text.isEmpty) {
        CommnWidget.showInSnackBar(
            "رجاء ادخل اسم الفاعلية", CommnWidget.commonColor, _scaffoldKey);
        return;
      }
