...
if(value==null){
  ...
  if(value){
  CommnWidget.showInSnackBar("تم حذف هذه الفاعلية من المفضلة", CommnWidget.commonColor, _scaffoldKey);
  
  getdata();
  }else{
     CommnWidget.showInSnackBar("هذه الفاعلية محذوفة  سابقا ", CommnWidget.commonColor, _scaffoldKey);
  }
}
                            });
                                      },
