  ...
  Widget build(BuildContext context) {
    ...
    Container(
                    ...
                    child: TextFormField(
                        maxLines: 10,
                        // minLines: 1,
                        maxLength: 150,textAlign: TextAlign.right,
                        onSaved: (value){
                        setState(() {
                          message = value;
                        });
                          ...
                          if(value.isEmpty)
{
  return  "رجاء ادخل رسالتك";
                        ...
                        decoration: new InputDecoration(hintText: "اكتب رسالتك هنا ",hintStyle: TextStyle( fontFamily: "thin",color: Colors.grey,),
...
print(message);
  ...
  //_goodleToken
     ...
     if(value!=null){
if(value){
        CommnWidget.showErrorDialog("حسنا","تم ارسال رسالتك بنجاح", DialogType.SUCCES, context);
     setState(() {
        _isLoading=false;
      });
