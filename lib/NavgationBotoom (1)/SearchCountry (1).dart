...
import 'package:dailyevent/Commnwidget (1).dart';
...
class DoctorSearch extends StatefulWidget {
  final SearchMModel data ;
  DoctorSearch({this.data});
              ...
              child: Column(
                children: <Widget>[
                  ListView.builder(
                    shrinkWrap: true,
                    primary: false,
                    itemCount: widget.data.data.eachcountry.length,
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: () {
                          Navigator.pop(context, {
                            "DoctorName":  widget.data.data.eachcountry[index].country.country,
                            "DoctorId":widget.data.data.eachcountry[index].country.id,
                            "searchcontyitem":widget.data.data.eachcountry[index]
                          });
                          ...
                          children: <Widget>[
                            Card(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    widget.data.data.eachcountry[index].country.country,
                                    style: TextStyle(
