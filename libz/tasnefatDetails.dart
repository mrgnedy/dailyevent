...
import 'package:events/MapPage.dart';
  ...
  Widget build(BuildContext context) {
                ...
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context){
                      return MapScreeen(lat: double.parse(widget.data.lat.toString()), long:double.parse(widget.data.lng.toString()),name: widget.data.name.toString(),);
                    }));
                  },
                                  child: Column(
                    children: <Widget>[
    ...
    CommnWidget.showInSnackBar2(" قم بتسجيل الدخول اولا", CommnWidget.commonColor, _scaffoldKey,context);    
                          ...
                          if (value == null) {
                            ...
                            if (value) {
                              CommnWidget.showInSnackBar(
                                  "تم اضافة هذه الفاعلية الي المفضلة",
                                  CommnWidget.commonColor,
                                  _scaffoldKey);
                            } else {
                              CommnWidget.showInSnackBar(
                                  "هذه الفاعلية مضافة سابقا ",
                                  CommnWidget.commonColor,
                                  _scaffoldKey);
                            }
                          }
