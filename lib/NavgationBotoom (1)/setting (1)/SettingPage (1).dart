...
import '../../aboutUs (1).dart';
import '../../loginPage (1).dart';
import '../ContactUs (1).dart';
import 'EditeProfile (1).dart';
import 'kayemEltatbek (1).dart';
        ...
        widget.isloading==false?Container():    Container(
          ...
          Column(
            ...
            children: <Widget>[
              ...
              InkWell(
                onTap: () {
                 Share.share("https://play.google.com/store/apps/details?id=event.katab.com.events3");
                },
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      IconButton(
                          ...
                          onPressed: () {
      Share.share("https://play.google.com/store/apps/details?id=com.khattab.dailyevent");
